...
(function () {
  ...
  var INDEX = [
    ...
    { t: 'The Farrlandia Census (download)', u: 'farrlandia/census/index.html', d: 'All 10,000 residents as CSV: 30 variables, codebook, and eight instructor lessons. Ready for R, Stata, SPSS, SAS, Python.', k: 'census download csv data 10000 codebook dictionary variables r stata spss sas python berkson confounding interaction coal mine colliery snow pump water occupation respiratory vulcan works closure layoff natural experiment nightingale clinic diagnosed ascertainment' },
